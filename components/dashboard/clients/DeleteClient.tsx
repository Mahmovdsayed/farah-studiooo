...
import { deleteClient } from "@/app/actions/clients/deleteClient.action";
...
const DeleteClient = ({ id, name }: IProps) => {
    ...
    const deleteClientFunc = async () => {
        try {
            ...
            toast.success("Client deleted successfully", {
                description: `The client ${name} has been deleted.`,
                duration: 3000,
                position: "top-center",
            });
            setopen(false);
    ...
    return <>
        <DialogContainer
            ...
            description={"This will delete your Client."}
